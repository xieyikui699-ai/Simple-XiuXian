  ...
  return (
    <View className="page">
      <View className="card">
        ...
        {rival ? (
          <View className="rival-facts">
            ...
            <Text className="muted">
              声望 {rival.prestige} · 士气 {rival.morale} · 灵石 {formatNumber(rival.spiritStones)}
            </Text>
            <Text className="muted">
        ...
        {state.warWithRival && <Text className="war-banner">⚔ 两宗已开战，来月月结触发会战！</Text>}
      ...
      {rival && (
        <View className="card">
          <View className="card-title">名册（{roster.length} 人，情报透明）</View>
          {roster.map((entry) => {
